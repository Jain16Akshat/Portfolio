        ...
        <Section className="bg-background/60 backdrop-blur-lg py-4 border-b border-border sticky top-0 z-50">
            <div className="flex justify-between items-center">
                <h1 className="basis-1/6 flex justify-center items-center">
                    <Link
                        href="/"
                        className="text-primary text-2xl font-bold hover:text-primary no-underline text-nowrap select-none flex items-center gap-3 h-10 max-mobile-sm:h-8 max-mobile-sm:text-wrap"
                    >
                        <img
                            src={logo}
                            alt="Akshat's image"
